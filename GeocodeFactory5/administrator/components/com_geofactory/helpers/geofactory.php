...
use Joomla\CMS\HTML\HTMLHelper;     // Per JHtml::_ 
use Joomla\CMS\Layout\FileLayout;
use Joomla\CMS\Plugin\PluginHelper; // Sostituisce JPluginHelper
use Joomla\CMS\Dispatcher\Dispatcher; // Per ottenere il dispatcher
...
// In Joomla 4 il metodo getActions() non esiste in Access, quindi usiamo Rules:
use Joomla\CMS\Access\Rules;
use Joomla\CMS\Toolbar\ToolbarHelper;
use Joomla\CMS\HTML\Sidebar;
use Joomla\CMS\Object\CMSObject; // Alternativa a JObject (se necessario)
...
{
    /**
     * Configura la “sidebar” (Linkbar) in Joomla 4, al posto di JSubMenuHelper
     *
    ...
    {
        // In Joomla 4, usiamo Sidebar::addEntry()
        Sidebar::addEntry(
    ...
    /**
     * Ritorna link di shortcut per la modifica di oggetti (es. Mappe / Markers)
     */
    public static function getLinksEditShortCuts($items, $task)
    {
        ...
        if (is_array($items) && count($items)) {
            foreach ($items as $item) {
                $res[] = '<a style="font-size:0.75em!important;" class="label btn-mini" '
     ...
     * In Joomla 3 si usava JDispatcher; in Joomla 4 si può usare l’Application con triggerEvent.
     */
